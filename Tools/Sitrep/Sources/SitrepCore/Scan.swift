...
// I edited the inheritances array in the createReport method to contain instances of the ClassStat class, thus adding also the occurrences dictionary for each class.
...
public struct Scan {
    ...
    public func createReport(for results: Results, files: [File], failures: [URL]) -> Report {
        ...
        let inheritances = [
            Report.ClassStat(name: "UIViewController", count: results.uiKitViewControllerCount, classes: results.uiKitViewControllers ),
            Report.ClassStat(name: "UIView", count: results.uiKitViewCount, classes: results.uiKitViews),
            Report.ClassStat(name: "SwiftUI.View", count: results.swiftUIViewCount, classes: results.swiftUIViews),
        ]
